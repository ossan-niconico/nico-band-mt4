...
MT4用インジケーター。1分足〜日足の7タイムフレームの
ATRトレンドバンドを1枚のチャートに同時表示します。

## ファイル

- `nico-band-7TF.mq4` — インジケーター本体

## インストール方法

1. `nico-band-7TF.mq4` をダウンロード
...
## 詳細マニュアル・配布記事
・配布記事　https://note.com/ossan_niconico/n/ne6a576edcc71
